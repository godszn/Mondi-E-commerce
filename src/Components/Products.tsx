...
const Products: React.FC<productProp> = ({oncardClick}) => {
    return (
        <div>
            <section className='Product-wrapper mt-[4rem]'>
                ...
                <div className="Product-widgets grid grid-cols-3 gap-4  mt-[2rem] ml-[13%] mr-[13%]">
                    <div className='flex flex-col items-center'>
                        ...
                        <button onClick={oncardClick} style={{color: 'blue'}}>
                            add to cart
                        </button>
                    </div>
                    <div className='flex flex-col items-center'>
                ...
                <section className='items-center flex justify-center mt-8'>
                    <button className='p-2 mb-4' style={{backgroundColor: 'blue' , color: 'white' , width: '135px' , borderRadius: '.5rem'}}>
                        View More
                    </button>
                </section>
            </section>
